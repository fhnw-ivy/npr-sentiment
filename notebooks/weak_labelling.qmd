...
As the `all-mpnet-base-v2` model performs better than the `all-MiniLM-L6-v2` model, we will mainly focus on the embeddings generated by the `all-mpnet-base-v2` model for the subsequent steps though weak labeling models based on the `all-MiniLM-L6-v2` are still trained to analyze the impact of the embedding space's representation.
...
for model_name, model_data in EMBEDDING_MODEL_DATA.items():
    print(f'Training Logistic Regression Model on {model_name}')
    ...
    logreg_models[model_name] = log_reg_grid_search.best_estimator_

    print(f'Best Parameters: {log_reg_grid_search.best_params_}')

    print_evaluation(y_val, log_reg_grid_search.best_estimator_.predict(X_val),
                    'Logistic Regression (Validation Set)')

    print_evaluation(y_test, log_reg_grid_search.best_estimator_.predict(X_test),
...
for model_name, model_data in EMBEDDING_MODEL_DATA.items():
    print(f'Training KNeighbors Model on {model_name}')
    ...
    knn_models[model_name] = grid_search.best_estimator_

    print(f'Best Parameters: {grid_search.best_params_}')

    print_evaluation(y_val, grid_search.best_estimator_.predict(X_val),
                    'KNeighbors Weak Labeling (Validation Set)')

    print_evaluation(y_test, grid_search.best_estimator_.predict(X_test),
...
for model_name, model_data in EMBEDDING_MODEL_DATA.items():
    print(f'Training KNeighbors Model on {model_name} (PCA Reduced)')
    ...
    pca_knn_models[model_name] = grid_search.best_estimator_

    print(f'Best Parameters: {grid_search.best_params_}')

    print_evaluation(y_val, grid_search.best_estimator_.predict(pca.transform(X_val)),
                    'KNeighbors Weak Labeling (PCA Reduced) (Validation Set)')

    print_evaluation(y_test, grid_search.best_estimator_.predict(pca.transform(X_test)),
...
for model_name, model_data in EMBEDDING_MODEL_DATA.items():
    print(f'Training Random Forest Model on {model_name}')
    ...
    rf_models[model_name] = rf_grid_search.best_estimator_

    print(f'Best Parameters: {rf_grid_search.best_params_}')

    print_evaluation(y_val, rf_grid_search.best_estimator_.predict(X_val),
                    'Random Forest (Validation Set)')

    print_evaluation(y_test, rf_grid_search.best_estimator_.predict(X_test),
...
for model_name, model_data in EMBEDDING_MODEL_DATA.items():
    print(f'Training Neural Network Model on {model_name}')
    ...
    mlp_models[model_name] = mlp_grid_search.best_estimator_
    print(f'Best Parameters: {mlp_grid_search.best_params_}')

    print_evaluation(y_val, mlp_grid_search.best_estimator_.predict(X_val),
                    'Neural Network (Validation Set)')

    print_evaluation(y_test, mlp_grid_search.best_estimator_.predict(X_test),
...
for model_name, model_data in EMBEDDING_MODEL_DATA.items():
    print(f'Training Support Vector Machine Model on {model_name}')
    ...
    svm_models[model_name] = svm_grid_search.best_estimator_
    print(f'Best Parameters: {svm_grid_search.best_params_}')

    print_evaluation(y_val, svm_grid_search.best_estimator_.predict(X_val),
                    'Support Vector Machine (Validation Set)')

    print_evaluation(y_test, svm_grid_search.best_estimator_.predict(X_test),
